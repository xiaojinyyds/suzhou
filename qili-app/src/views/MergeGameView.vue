...
const MASCOTS = [
  {
    ...
    rarityColor: '#b0b8c1',
    story:
      '白公是苏州民间传说中最质朴的狸猫精灵，象征着初心与好奇。据说每逢月圆之夜，白工会悄悄溜进苏州的小巷，用天真无邪的眼睛凝望古城的灯火。它是所有狸猫的起点，也是一切故事的开始。',
  ...
  },
  {
    ...
    rarityColor: '#9b6dbd',
    story:
      '美仁狸猫是苏州园林的守护者，它能幻化为婉约的江南女子，在月下抚琴。相传拙政园深处的花影，有时便是美仁轻舞的倩影。她的美不在妆容，而在能感受园林四季更迭的细腻之心。',
    location: '拙政园荷花池旁的回廊',
  },
  {
    name: '通贵',
    ...
    rarityColor: '#d4a017',
    story:
      '通贵狸猫是苏州商贾最敬重的财神化身。明清时期，丝绸商人开铺前必请通贵像镇店，据说摸过铜贵尾巴的算盘，拨出的每个数字都能化为真金。苏绣中有一针法便以"通贵纹"命名，象征生意兴隆。',
    location: '平江路上的百年老字号',
  },
  {
    name: '文星',
    ...
    rarityColor: '#c0392b',
    story:
      '文星狸猫是苏州七狸之首，集天地灵气而生。苏州历史上状元辈出，民间皆传是文星在夜里悄悄为学子磨墨、续灯。相传每年科举放榜之日，若在文庙前看到一只翠色狸猫，便是文星显灵、告知中第之兆。',
    location: '苏州文庙的古银杏树下',
  },
]
